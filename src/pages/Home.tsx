...
export default function Home() {
  const projects: Project[] = [
    ...
    { link: '', img: '/images/lone-palm-island.png', pixel: false, title: 'Lone Palm Island', description: 'A 3D Demo Written in C++' },
    { link: '', img: '/images/dive-into-2025-front.png', pixel: false, title: 'Dive Into 2025', description: 'Double Exposure Postcard'}
  ];
